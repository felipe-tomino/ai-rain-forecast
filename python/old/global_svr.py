# este algoritmo cria um regressor SVR global (sem dividir por sensor)
import psycopg2
...
pickle.dump(regr, open('./SVR_regressors/global', 'wb'))
...
with open('./results/global_SVR.csv', 'w') as f:
